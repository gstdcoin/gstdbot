            ...
            if (this.isAdminImpersonation(text, ctx)) {
                try {
                    ...
                    if (w >= 2) {
                        ...
                        await ctx.reply('⚠️ You are not an admin. Only official admins can manage the chat.',
            ...
            if (this.isProfanity(text)) {
                try {
                    ...
                    if (w >= 3) {
                        ...
                        await ctx.reply(`⚠️ Profanity is not allowed. Warning ${w}/3.`,
            ...
            try {
                ...
                if (lastPrice > 0 && price > lastPrice * 1.02) {
                    ...
                    await bot.api.sendMessage(chatId,
                        ...
                        `📈 [Buy](${PLATFORM_KB.buyLinks.stonfi})`,
                        { parse_mode: 'Markdown', link_preview_options: { is_disabled: true } }
                    );
                }
                lastPrice = price;
